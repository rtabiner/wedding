...
render() {
    ...
    return (
      ...
      <div>
        ...
        <Grid item sm={3}>
        <TravelMode cardText='Flying to Ireland'>
            <FlightIcon style={{fill: '#94b8af', width: 60, height: 60}} />
            </TravelMode>        
        </Grid>
        <Grid item sm={3}>
        <TravelMode cardText='Jump on the train'>
        <TrainIcon />
            </TravelMode>
        </Grid>
        <Grid item sm={3}>
        <TravelMode cardText='Catching a bus'>
        <BusIcon />
            </TravelMode>
        </Grid>
        <Grid item sm={3}>
        <TravelMode cardText='Driving by car'>
        <CarIcon />
            </TravelMode>
        </Grid>
      </Grid>
